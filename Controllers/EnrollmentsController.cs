...
namespace AspTwo.Controllers
{
    public class EnrollmentsController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Enrollments.Include(e => e.Courses).Include(e => e.Students);
        ...
        public async Task<IActionResult> Create([Bind("EnrollmentId,Grades,FkStudentId,FkCourseId")] Enrollment enrollment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EnrollmentId,Grades,FkStudentId,FkCourseId")] Enrollment enrollment)
        {
